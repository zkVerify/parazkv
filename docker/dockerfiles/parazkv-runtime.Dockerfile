ARG PROFILE="release"
ARG FEATURES=""
ARG RUNTIME_CRATE="parazkv-runtime"
...
ARG DESCRIPTION="Parazkv Runtime"
...
COPY --from=builder "/usr/src/parazkv-node/target/${PROFILE}/wbuild/${RUNTIME_CRATE}/*.compact.compressed.wasm" "."